...
def main():
    ...
    dirs = ["stack_evi", "stack_ndvi", "stack_msavi", "stack_reip", "stack_rvi"]
    ...
    for dir in dirs:
        ...
        dstfile = 'F:/geodata/geo402/S2/xx_S2_indices/mosaics/' + dir + '.vrt'
        ...
        stack(srcfiles=groups, dstfile=dstfile, resampling='bilinear',
              targetres=[30, 30], srcnodata=-99, dstnodata=-99,
